...
export function LandingPage({ lang = 'en' }: LandingPageProps) {
    ...
    return (
        <Box sx={{ minHeight: '100vh', backgroundColor: '#0b1326', color: '#dae2fd' }}>
            ...
            <Box component="header" sx={{ borderBottom: '1px solid rgba(255, 255, 255, 0.08)', py: 2 }}>
                <Container maxWidth="lg" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Box component="nav" sx={{ display: { xs: 'none', md: 'flex' }, gap: 3, alignItems: 'center' }}>
                        <Link href="#pipeline" underline="none" sx={{
                            color: '#bbcabf',
                            fontSize: '0.9rem',
                            fontWeight: 500,
                            '&:hover': {color: '#ffffff'}
            ...
            {/* Hero Section */}
            <Container maxWidth="md" sx={{pt: {xs: 4, md: 6}, pb: {xs: 8, md: 10}, textAlign: 'center'}}>
                <Chip
                    label={t.heroBadge}
                    size="small"
                    sx={{
            ...
            {/* Metrics Section */}
            <Container maxWidth="lg" component="section" sx={{mb: 2}}>
                <Box sx={{
                    display: 'grid',
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{display: 'flex', alignItems: 'center', gap: 1, color: '#94a3b8'}}>
                                <Box component="span" className="material-icons"
                                     sx={{fontSize: 16, color: '#10b981'}}>sync</Box>
                                <Typography variant="caption" sx={{color: '#94a3b8'}}>finance.xardbaiz.im / ideas (200
                                    OK)</Typography>
                            </Box>
                            <Typography variant="caption" sx={{color: '#10b981', fontWeight: 600}}>Vector Cosine
                                Similarity</Typography>
                        </Box>
                        ...
                        <Box sx={{display: 'grid', gridTemplateColumns: {xs: '1fr', sm: 'repeat(2, 1fr)'}, gap: 2}}>
                            <Paper elevation={0} sx={{
                                ...
                                <Box sx={{display: 'flex', justifyContent: 'space-between', mb: 1}}>
                                    ...
                                    <Chip label={t.previewMatch79} size="small" sx={{
                                        fontSize: '0.75rem',
                                        color: '#34d399',
                                        backgroundColor: 'rgba(16, 185, 129, 0.15)'
                                    }}/>
                                </Box>
                                <Typography sx={{color: '#bbcabf', fontSize: '0.9rem', mb: 1.5}}>Clear Secure
                                    Inc</Typography>
                                <Typography sx={{
                                    color: '#10b981',
                                    fontWeight: 600,
                                    fontSize: '0.95rem'
                                }}>{t.previewTargetUpside1}</Typography>
                            </Paper>
                            ...
                            <Paper elevation={0} sx={{
                                ...
                                <Typography sx={{color: '#bbcabf', fontSize: '0.9rem', mb: 1.5}}>Adobe Systems
                                    Inc</Typography>
                                <Typography sx={{
                                    color: '#10b981',
                                    fontWeight: 600,
                                    fontSize: '0.95rem'
                                }}>{t.previewTargetUpside2}</Typography>
                            </Paper>
                        </Box>
                        ...
                        <Card key={idx} elevation={0} sx={{
                            ...
                            <CardContent sx={{p: 3.5}}>
                                <Box sx={{
                                    ...
                                    <Box component="span" className="material-icons"
                                         sx={{fontSize: 32, color: '#10b981'}}>{step.icon}</Box>
                                    <Typography sx={{
                                        fontSize: '0.85rem',
                                        fontWeight: 700,
                                        color: '#475569'
                                    }}>Step {step.step}</Typography>
                                </Box>
                                ...
                                <Typography sx={{
                                    ...
                                    lineHeight: 1.5,
                                    mb: 2.5
                                }}>{step.desc}</Typography>
                                <Chip label={step.tag} size="small" sx={{
                                    fontSize: '0.75rem',
                                    color: '#95d3ba',
